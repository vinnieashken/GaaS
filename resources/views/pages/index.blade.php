            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6 col-xl-4 d-flex">
                    <div class="card flex-fill w-100">
                        ...
                        <div class="card-body">
                            <div class="media">
                                <img src="img/avatar-5.jpg" width="36" height="36" class="rounded-circle mr-2" alt="Kathy Davis">
                            ...
                            <hr />
                            <div class="media">
                                <img src="img/avatar.jpg" width="36" height="36" class="rounded-circle mr-2" alt="Andrew Jones">
                                <div class="media-body">
                            ...
                            <hr />
                            <div class="media">
                                <img src="img/avatar-4.jpg" width="36" height="36" class="rounded-circle mr-2" alt="Marie Salter">
                                <div class="media-body">
