        ...
        <div class="col-md-12 mt-3">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Edit App</h5>
                    ...
                    <form method="POST" action="{{ route('apps.update',$app)  }}">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="name" class="form-control"  placeholder="Name" value="{{ old('name',$app->name) }}" required >
                                @if($errors->has('name'))
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select class="form-control" name="status">
                                    @foreach($statuses as $status)
                                        <option @if($app->status == $status) selected @endif value="{{ $status }}">{{ ucfirst($status) }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            @else
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="email" name="parent_email" class="form-control"  placeholder="Optional email of parent account" value="{{ old('parent_email',$app->user->email) }}">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="description" rows="3" class="form-control w-100">{{ $app->description }}</textarea>
